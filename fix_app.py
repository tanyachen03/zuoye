...
# Lines 181-192 in file = indices 180-191
# We want to replace indices 180-191 with the new content
new_lines = lines[:180] + [new_chapter1 + '\n'] + lines[192:]
...
import ast
try:
    ast.parse(open('/workspace/app.py').read())
    print("SYNTAX OK!")
