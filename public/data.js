...
const datasetsData = {
    ...
    'marketing_data': {
        ...
        name: '市场调研数据',
        desc: '500份用户调研问卷',
        file: 'datasets/marketing_data.csv',
        columns: ['ID', '年龄', '性别', '收入', '职业', '消费偏好', '满意度', '推荐意愿'],
        preview: [
            ['M001', 25, '女', '5000-8000', '白领', '电子产品', 4.5, 1],
            ['M002', 32, '男', '8000-12000', '工程师', '户外运动', 4.0, 1],
            ['M003', 45, '女', '12000-20000', '经理', '奢侈品', 5.0, 1]
        ]
    },
    'ad_campaign': {
        id: 'ad_campaign',
        name: '广告投放数据',
        desc: '12个月广告投放效果',
        file: 'datasets/ad_campaign.csv',
        columns: ['日期', '渠道', '投放金额', '曝光量', '点击量', '转化量', 'ROI'],
        preview: [
            ['2024-01', '抖音', 50000, 1200000, 45000, 1200, 2.4],
            ['2024-01', '微信', 30000, 800000, 32000, 850, 2.8],
            ['2024-02', '小红书', 40000, 950000, 38000, 980, 2.45]
        ]
    },
    'supply_chain': {
        id: 'supply_chain',
        name: '供应链数据',
        desc: '供应商配送效率分析',
        file: 'datasets/supply_chain.csv',
        columns: ['供应商ID', '名称', '城市', '交货周期', '合格率', '价格等级', '合作年限'],
        preview: [
            ['S001', '鑫源科技', '深圳', 3, 99.5, 'A', 5],
            ['S002', '华盛电子', '东莞', 5, 98.2, 'B', 3],
            ['S003', '恒通物流', '上海', 2, 99.8, 'A', 8]
        ]
    },
    'user_reviews': {
        id: 'user_reviews',
        name: '用户评价数据',
        desc: '200条商品评价',
        file: 'datasets/user_reviews.csv',
        columns: ['评价ID', '商品ID', '用户ID', '评分', '评价内容', '日期', '是否推荐'],
        preview: [
            ['R001', 'P001', 'U001', 5, '商品质量很好，物流也很快', '2024-01-15', 1],
            ['R002', 'P002', 'U002', 4, '整体不错，包装精美', '2024-01-16', 1],
            ['R003', 'P001', 'U003', 3, '一般般，价格偏高', '2024-01-17', 0]
        ]
    },
    'financial_report': {
        id: 'financial_report',
        name: '财务报表数据',
        desc: '年度财务数据分析',
        file: 'datasets/financial_report.csv',
        columns: ['月份', '营业收入', '营业成本', '净利润', '毛利率', '费用率', '现金流'],
        preview: [
            ['2024-01', 5200000, 3120000, 884000, 40, 15, 450000],
            ['2024-02', 4800000, 2880000, 816000, 40, 14, 420000],
            ['2024-03', 5500000, 3300000, 935000, 40, 13, 480000]
        ]
    },
    'web_traffic': {
        id: 'web_traffic',
        name: '网站流量数据',
        desc: '网站访问统计数据',
        file: 'datasets/web_traffic.csv',
        columns: ['日期', '访问量', '独立访客', '页面浏览量', '跳出率', '平均停留时间', '转化率'],
        preview: [
            ['2024-01-01', 12500, 8500, 32000, 45, 3.5, 3.2],
            ['2024-01-02', 11800, 7800, 29500, 47, 3.2, 3.0],
            ['2024-01-03', 13200, 9000, 34500, 42, 3.8, 3.5]
        ]
    }
};